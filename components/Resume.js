    ...
    <div className="p-10 text-center ">
      <Typewriter
        options={{
          ...
          wrapperClassName:
            "max-w-xl py-2 text-4xl font-medium text-blue-700 md:text-6xl ",
          cursor: "",
          cursorClassName:
            "max-w-xl py-2 text-4xl font-medium text-blue-700 md:text-6xl ",
        }}
      ...
      <Typewriter
        ...
        options={{
          ...
          autoStart: true,
          loop: true,
          wrapperClassName: "py-2 text-2xl md:text-3xl dark:text-white",
          cursor: "",
          cursorClassName: "py-2 text-2xl md:text-3xl dark:text-white",
        }}
      />
