...
export default function Contact() {
  ...
  return (
    <main className="flex items-center justify-center h-screen bg-blue-500">
      <form onSubmit={formik.handleSubmit} className="flex w-2/3 font-sans bg-white rounded-lg">
        <div className="flex-1 p-20 text-gray-700">
          ...
          <div className="mt-6">
            ...
            {/* Country input field */}
            <div className="pb-4">
              <label className="block pb-2 text-sm" htmlFor="country">
                Country
              </label>
              <select
                name="country"
            ...
            {/* terms of service*/}
            <div className="pb-4">
              <label className="block pb-2 text-sm" htmlFor="terms">
                Terms of service
              </label>
